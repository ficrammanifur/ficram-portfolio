...
class RobotHead3D {
    ...
    animate() {
        ...
        if (robotHead) {
            // Smooth rotation with correct Y-axis movement
...
class TestimonialManager {
    ...
    handleSubmit(e) {
        ...
        // Save to Firebase
        database.ref('messages').push(testimonial)
            .then(() => {
    ...
    loadTestimonials() {
        database.ref('messages').on('value', snapshot => {
            ...
            messages.forEach(testimonial => {
                ...
                const timeAgo = this.getTimeAgo(new Date(testimonial.timestamp));
...
class PortfolioApp {
    ...
    initializeComponents() {
        ...
        document.getElementById('download-reume').addEventListener('click', () => {
